<template>
	<div
		class="w-1/2 mb-8 ml-8 mt-8 p-4 bg-stone-100 rounded-lg drop-shadow-xl overflow-y-auto z-10"
	>
		<h2 class="text-2xl font-semibold mb-4">
			mp-konsole v1.0.0 - {{ new Date().toDateString() }}
		</h2>
		<form @submit.prevent="generateJson">
			...
			<fieldset class="mb-6 flex flex-row gap-2">
				...
				<div class="mb-4 w-2/3">
					<label for="subject" class="block text-gray-700 font-bold"
						>Betreff:</label
					>
					<input
						type="text"
				...
				<div class="mb-4 w-1/3 hidden">
					<label for="letterhead" class="block text-gray-700 font-bold"
						>Vorlage:</label
					>
					<input
						type="text"
			...
			<fieldset class="mb-6 flex flex-row gap-2">
				...
				<div class="mb-4 w-1/4">
					<label for="invoiceNr" class="block text-gray-700 font-bold"
						>Rechnung Nr.:</label
					>
					<input
						type="text"
				...
				<!-- Customer Number -->
				<div class="mb-4 w-1/4">
					<label for="customerNr" class="block text-gray-700 font-bold"
						>Kunden Nr.</label
					>
					<input
						type="text"
				...
				<!-- Order Number -->
				<div class="mb-4 w-1/4">
					<label for="orderNr" class="block text-gray-700 font-bold"
						>Bestellnr.:</label
					>
					<input
						type="text"
			...
			<fieldset class="mb-6 flex flex-row gap-2">
				...
				<div class="mb-4 w-1/2">
					<label for="customerName" class="block text-gray-700 font-bold"
						>Name:</label
					>
					<input
						type="text"
				...
				<!-- Customer Address -->
				<div class="mb-4 w-1/2">
					<label for="customerAddress" class="block text-gray-700 font-bold"
			...
			<fieldset class="mb-6 flex flex-row gap-2">
				...
				<div class="mb-4 w-1/5">
					<label for="VATRate" class="block text-gray-700 font-bold"
						>USt. (in %):</label
					>
					<input
						type="number"
				...
				<!-- VAT Amount -->
				<div class="mb-4 w-1/5">
					<label for="VATAmount" class="block text-gray-700 font-bold"
						>USt. (in EUR):</label
					>
					<input
						type="number"
				...
				<!-- Shipping -->
				<div class="mb-4 w-1/5">
					<label for="shipping" class="block text-gray-700 font-bold"
						>Versand (in EUR):</label
					>
					<input
						type="number"
						id="shipping"
				...
				<div class="mb-4 w-1/5 hidden">
					<label for="currency" class="block text-gray-700 font-bold"
						>Currency:</label
					>
					<input
						type="text"
				...
				<!-- Subtotal -->
				<div class="mb-4 w-1/5">
					<label for="subtotal" class="block text-gray-700 font-bold"
						>Subtotal:</label
					>
					<input
						type="number"
				...
				<!-- Total -->
				<div class="mb-4 w-1/5">
					<label for="total" class="block text-gray-700 font-bold"
						>Gesamt:</label
					>
					<input
						type="number"
			...
			<button
				type="submit"
				class="w-full px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-700"
			>
				PDF erstellen
			</button>
		</form>
	</div>
	<pre v-if="invoiceData" class="text-white m-8 overflow-x-auto w-1/2">{{
