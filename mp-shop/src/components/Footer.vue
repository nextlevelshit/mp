	...
	<footer class="bg-gray-800 text-white mt-40 pt-8 lg:pt-20">
		<div class="mx-auto container p-4 py-6 lg:py-8">
			<div class="md:flex md:justify-between">
				<div class="mb-12">
					<router-link to="/" class="flex items-center" @click="trackEvent(`footer-logo-clicked`)">
						<span class="tracking-wide text-3xl font-bebas leading-none">
							MUELLERPRINTS.<br/>Paperwork
						</span>
					</router-link>
				</div>
				<div class="grid grid-cols-1 gap-8 lg:gap-6 lg:grid-cols-3">
					<div>
			...
			<div class="flex flex-col-reverse lg:flex-row items-center justify-between gap-8">
				<span class="text-gray-400">
					© {{ new Date().getFullYear() }} <a href="/" class="hover:text-white">MUELLERPRINTS. PAPERWORK</a> – Alle Rechte vorbehalten
				</span>
				<div class="flex flex-col lg:flex-row mt-4 lg:mt-0 items-start lg:items-center text-gray-400 gap-8">
					<span>
						Du kannst bei uns mit VISA, Mastercard und PayPal bezahlen
					</span>
